document.addEventListener("DOMContentLoaded", () => {
    ...
    const instruments = [
        ...
        // { id: 'round-gong', category: 'gongs', image: "Instruments/GONGS/round_gong/HUB_1151_GONG_TRANSP.webp", sound: "Instruments/GONGS/round_gong/1.ogg", buffer: null, activeInstances: [], isLooping: false, name: "Round Gong", material: "Unknown", year: "Unknown" },
        { id: 'grave-gong', category: 'gongs', image: "assets/images/gravegongfooter.jpg", sound: "Instruments/GONGS/grave_gong/3s.ogg", buffer: null, activeInstances: [], isLooping: false, name: "Grave Gong", material: "Bronze", year: "Made in 1975", size: "120 × 4 in.", link: "https://harrybertoia.org/gongs/" },

        // SINGING BARS
        { id: 'short-thick', category: 'singing-bars', image: "assets/images/singingbar1.webp", sound: "", buffer: null, activeInstances: [], isLooping: false, name: "Short Thick", material: "Beryllium copper", year: "Made in the 1970s", size: "8 × 7/8 in.", link: "https://catalogue.harrybertoia.org/catalogue/entry.php?id=333" },
        { id: 'short-thicker', category: 'singing-bars', image: "assets/images/singingbar2.webp", sound: "Instruments/SINGING BARS/singingbars1/singingbars2/singingbar2.ogg", buffer: null, activeInstances: [], isLooping: false, name: "Short Thicker", material: "Beryllium copper", year: "Made in the 1970s", size: "8.75 × 1.125 in.", link: "https://catalogue.harrybertoia.org/catalogue/entry.php?id=334" },
        { id: 'long-bars', category: 'singing-bars', image: "assets/images/singingbar3.webp", sound: "", buffer: null, activeInstances: [], isLooping: false, name: "Long Bars", material: "Beryllium copper", year: "Made in the 1970s", size: "13.5 × .75 in.", link: "https://catalogue.harrybertoia.org/catalogue/entry.php?id=336" },
        ...
        // COMBINATIONS
        { id: 'gong-and-bars', category: 'combinations', image: "assets/images/Combination1.webp", sound: "Instruments/SINGING BARS/singingbars1/1m16s_swinging bars_gong_drone_rods_LP.ogg", buffer: null, activeInstances: [], isLooping: false, name: "Gong & Bars", material: "Copper and bronze", year: "Made in the 1970s", size: "Varied" },
        { id: 'gong-and-bars-2', category: 'combinations', image: "assets/images/combo2.webp", sound: "Instruments/SINGING BARS/singingbars1/singingbars3/45s_swinging bars LP opening edit.ogg", buffer: null, activeInstances: [], isLooping: false, name: "Gong & Bars 2", material: "Copper and bronze", year: "Made in the 1970s", size: "Varied" },
